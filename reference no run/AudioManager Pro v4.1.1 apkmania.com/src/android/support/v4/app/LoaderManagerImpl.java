  ...
  extends LoaderManager
{
  ...
  public void destroyLoader(int paramInt)
  {
    if (!this.mCreatingLoader)
    {
      ...
      int i = this.mInactiveLoaders.indexOfKey(paramInt);
      if (i >= 0)
      {
  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    ...
    for (int j = 0;; str2++)
    {
      ...
      LoaderInfo localLoaderInfo = (LoaderInfo)this.mLoaders.valueAt(str2);
      paramPrintWriter.print(paramString);
      paramPrintWriter.print("  #");
      paramPrintWriter.print(this.mLoaders.keyAt(str2));
      paramPrintWriter.print(": ");
      paramPrintWriter.println(localLoaderInfo.toString());
      localLoaderInfo.dump(i, paramFileDescriptor, paramPrintWriter, paramArrayOfString);
    }
  }
