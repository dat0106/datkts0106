  ...
  implements android.app.ActionBar.OnNavigationListener, android.app.ActionBar.OnMenuVisibilityListener
{
  ...
  {
    Object localObject = this.mActionBar.getSelectedTab();
    if (localObject == null) {
      localObject = null;
    } else {
      localObject = (com.actionbarsherlock.app.ActionBar.Tab)((android.app.ActionBar.Tab)localObject).getTag();
    }
    return localObject;
  }
  ...
  {
    Object localObject = this.mActionBar.getTabAt(paramInt);
    if (localObject == null) {
      localObject = null;
    } else {
      localObject = (com.actionbarsherlock.app.ActionBar.Tab)((android.app.ActionBar.Tab)localObject).getTag();
    ...
    implements android.app.ActionBar.TabListener
  {
    ...
    public com.actionbarsherlock.app.ActionBar.Tab setTabListener(com.actionbarsherlock.app.ActionBar.TabListener paramTabListener)
    {
      ...
      TabWrapper localTabWrapper;
      if (paramTabListener == null) {
        localTabWrapper = null;
      } else {
        localTabWrapper = this;
      }
