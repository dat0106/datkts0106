    ...
    implements p
  {
    ...
    public static p aO(IBinder paramIBinder)
    {
      ...
      if (paramIBinder != null)
      {
        ...
        if ((localObject == null) || (!(localObject instanceof p))) {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        if (paramParcel1.readInt() == 0) {
          ...
          localStreetViewPanoramaCamera = StreetViewPanoramaCamera.CREATOR.createFromParcel(paramParcel1);
        }
      ...
      implements p
    {
        ...
        throws RemoteException
      {
        ...
        //   27: aload 4
        //   29: iconst_0
        //   30: invokevirtual 46	com/google/android/gms/maps/model/StreetViewPanoramaCamera:writeToParcel	(Landroid/os/Parcel;I)V
        //   33: aload_0
        //   34: getfield 18	com/google/android/gms/maps/internal/p$a$a:ko	Landroid/os/IBinder;
        //   37: iconst_1
        //   38: aload 4
        //   40: aload_3
        //   41: iconst_0
        ...
        //   0	83	0	this	a
        //   0	83	1	paramStreetViewPanoramaCamera	StreetViewPanoramaCamera
