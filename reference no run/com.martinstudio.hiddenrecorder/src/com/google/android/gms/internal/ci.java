  ...
  implements SafeParcelable
{
  ...
  public static ci a(Intent paramIntent)
  {
    try
    {
      localObject = paramIntent.getBundleExtra("com.google.android.gms.ads.inernal.overlay.AdOverlayInfo");
      ((Bundle)localObject).setClassLoader(ci.class.getClassLoader());
      localObject = (ci)((Bundle)localObject).getParcelable("com.google.android.gms.ads.inernal.overlay.AdOverlayInfo");
      return localObject;
    }
