  ...
  implements TurnBasedMultiplayer
{
  ...
  {
    ParticipantResult[] arrayOfParticipantResult;
    if (paramList != null) {
      arrayOfParticipantResult = (ParticipantResult[])paramList.toArray(new ParticipantResult[paramList.size()]);
    } else {
      arrayOfParticipantResult = null;
    }
